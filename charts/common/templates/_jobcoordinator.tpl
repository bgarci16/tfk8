{{- define "threadfix.jobcoordinator.name" -}}
{{- $chart := "jobcoordinator" -}}
...
{{- define "threadfix.jobcoordinator.fullname" -}}
{{- $chart := "jobcoordinator" -}}
{{- if eq $chart .Chart.Name -}}
...
{{- define "threadfix.jobcoordinator.servicePort" -}}
{{- $chart := "jobcoordinator" -}}
{{- if eq $chart .Chart.Name -}}
...
Selector labels
*/}}
{{- define "threadfix.jobcoordinator.selectorLabels" -}}
app.kubernetes.io/name: {{ include "threadfix.jobcoordinator.name" . }}
