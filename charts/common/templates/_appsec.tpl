...
{{- define "threadfix.appsec.fullname" -}}
{{- $chart := "appsec" -}}
{{- if eq $chart .Chart.Name -}}
...
{{- define "threadfix.appsec.servicePort" -}}
{{- $chart := "appsec" -}}
{{- if eq $chart .Chart.Name -}}
...
Selector labels
*/}}
{{- define "threadfix.appsec.selectorLabels" -}}
app.kubernetes.io/name: {{ include "threadfix.appsec.name" . }}
