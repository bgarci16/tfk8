{{- define "threadfix.websocket.name" -}}
{{- $chart := "websocket" -}}
...
{{- define "threadfix.websocket.fullname" -}}
{{- $chart := "websocket" -}}
{{- if eq $chart .Chart.Name -}}
...
{{- define "threadfix.websocket.servicePort" -}}
{{- $chart := "websocket" -}}
{{- if eq $chart .Chart.Name -}}
...
Selector labels
*/}}
{{- define "threadfix.websocket.selectorLabels" -}}
app.kubernetes.io/name: {{ include "threadfix.websocket.name" . }}
