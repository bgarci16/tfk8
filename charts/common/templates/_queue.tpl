...
{{- define "threadfix.queue.fullname" -}}
{{- $chart := "queue" -}}
{{- if eq $chart .Chart.Name -}}
...
{{- define "threadfix.queue.servicePort" -}}
{{- $chart := "queue" -}}
{{- if eq $chart .Chart.Name -}}
...
Selector labels
*/}}
{{- define "threadfix.queue.selectorLabels" -}}
app.kubernetes.io/name: {{ include "threadfix.queue.name" . }}
