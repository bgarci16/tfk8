{{- define "threadfix.appsecvip.name" -}}
{{- $chart := "appsecvip" -}}
...
{{- define "threadfix.appsecvip.fullname" -}}
{{- $chart := "appsecvip" -}}
{{- if eq $chart .Chart.Name -}}
...
{{- define "threadfix.appsecvip.servicePort" -}}
{{- $chart := "appsecvip" -}}
{{- if eq $chart .Chart.Name -}}
...
Selector labels
*/}}
{{- define "threadfix.appsecvip.selectorLabels" -}}
app.kubernetes.io/name: {{ include "threadfix.appsecvip.name" . }}
