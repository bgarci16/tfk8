{{- define "threadfix.importer.name" -}}
{{- $chart := "importer" -}}
...
{{- define "threadfix.importer.fullname" -}}
{{- $chart := "importer" -}}
{{- if eq $chart .Chart.Name -}}
...
{{- define "threadfix.importer.servicePort" -}}
{{- $chart := "importer" -}}
{{- if eq $chart .Chart.Name -}}
...
Selector labels
*/}}
{{- define "threadfix.importer.selectorLabels" -}}
app.kubernetes.io/name: {{ include "threadfix.importer.name" . }}
