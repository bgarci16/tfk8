{{- define "threadfix.appsecimporter.name" -}}
{{- $chart := "appsecimporter" -}}
...
{{- define "threadfix.appsecimporter.fullname" -}}
{{- $chart := "appsecimporter" -}}
{{- if eq $chart .Chart.Name -}}
...
{{- define "threadfix.appsecimporter.servicePort" -}}
{{- $chart := "appsecimporter" -}}
{{- if eq $chart .Chart.Name -}}
...
Selector labels
*/}}
{{- define "threadfix.appsecimporter.selectorLabels" -}}
app.kubernetes.io/name: {{ include "threadfix.appsecimporter.name" . }}
